...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Internal)(nil), (*gcp.Internal)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Internal_To_gcp_Internal(a.(*Internal), b.(*gcp.Internal), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*gcp.Internal)(nil), (*Internal)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_gcp_Internal_To_v1alpha1_Internal(a.(*gcp.Internal), b.(*Internal), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*InternalOnly)(nil), (*gcp.InternalOnly)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_InternalOnly_To_gcp_InternalOnly(a.(*InternalOnly), b.(*gcp.InternalOnly), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*gcp.InternalOnly)(nil), (*InternalOnly)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_gcp_InternalOnly_To_v1alpha1_InternalOnly(a.(*gcp.InternalOnly), b.(*InternalOnly), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Internal_To_gcp_Internal(in *Internal, out *gcp.Internal, s conversion.Scope) error {
	out.CIDR = (*string)(unsafe.Pointer(in.CIDR))
	out.Name = (*string)(unsafe.Pointer(in.Name))
	out.InternalOnly = (*gcp.InternalOnly)(unsafe.Pointer(in.InternalOnly))
	return nil
}

// Convert_v1alpha1_Internal_To_gcp_Internal is an autogenerated conversion function.
func Convert_v1alpha1_Internal_To_gcp_Internal(in *Internal, out *gcp.Internal, s conversion.Scope) error {
	return autoConvert_v1alpha1_Internal_To_gcp_Internal(in, out, s)
}

func autoConvert_gcp_Internal_To_v1alpha1_Internal(in *gcp.Internal, out *Internal, s conversion.Scope) error {
	out.CIDR = (*string)(unsafe.Pointer(in.CIDR))
	out.Name = (*string)(unsafe.Pointer(in.Name))
	out.InternalOnly = (*InternalOnly)(unsafe.Pointer(in.InternalOnly))
	return nil
}

// Convert_gcp_Internal_To_v1alpha1_Internal is an autogenerated conversion function.
func Convert_gcp_Internal_To_v1alpha1_Internal(in *gcp.Internal, out *Internal, s conversion.Scope) error {
	return autoConvert_gcp_Internal_To_v1alpha1_Internal(in, out, s)
}

func autoConvert_v1alpha1_InternalOnly_To_gcp_InternalOnly(in *InternalOnly, out *gcp.InternalOnly, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_v1alpha1_InternalOnly_To_gcp_InternalOnly is an autogenerated conversion function.
func Convert_v1alpha1_InternalOnly_To_gcp_InternalOnly(in *InternalOnly, out *gcp.InternalOnly, s conversion.Scope) error {
	return autoConvert_v1alpha1_InternalOnly_To_gcp_InternalOnly(in, out, s)
}

func autoConvert_gcp_InternalOnly_To_v1alpha1_InternalOnly(in *gcp.InternalOnly, out *InternalOnly, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_gcp_InternalOnly_To_v1alpha1_InternalOnly is an autogenerated conversion function.
func Convert_gcp_InternalOnly_To_v1alpha1_InternalOnly(in *gcp.InternalOnly, out *InternalOnly, s conversion.Scope) error {
	return autoConvert_gcp_InternalOnly_To_v1alpha1_InternalOnly(in, out, s)
}
...
func autoConvert_v1alpha1_NetworkConfig_To_gcp_NetworkConfig(in *NetworkConfig, out *gcp.NetworkConfig, s conversion.Scope) error {
	...
	out.Internal = (*gcp.Internal)(unsafe.Pointer(in.Internal))
...
func autoConvert_gcp_NetworkConfig_To_v1alpha1_NetworkConfig(in *gcp.NetworkConfig, out *NetworkConfig, s conversion.Scope) error {
	...
	out.Internal = (*Internal)(unsafe.Pointer(in.Internal))
	out.Worker = in.Worker
	out.Workers = in.Workers
