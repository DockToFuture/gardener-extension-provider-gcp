...
func (in *Internal) DeepCopyInto(out *Internal) {
	*out = *in
	...
	if in.InternalOnly != nil {
		in, out := &in.InternalOnly, &out.InternalOnly
		*out = new(InternalOnly)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InternalOnly) DeepCopyInto(out *InternalOnly) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InternalOnly.
func (in *InternalOnly) DeepCopy() *InternalOnly {
	if in == nil {
		return nil
	}
	out := new(InternalOnly)
